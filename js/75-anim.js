...
(function (root) {
  ...
  function animateFly(fly, ms, keep) {
    return new Promise(function (resolve) {
      ...
      (Timeline ? Timeline.frame.bind(Timeline, 'animation') : requestAnimationFrame)(function () {
  ...
  Anim.useCard = function (data) {
    ...
    return animateFly(fly, dur('playCard'), true).then(function () {
      ...
      if (Timeline) Timeline.after('animation', 260, function () { fly.el.remove(); });
  ...
  Anim.aoe = function (data) {
    ...
    if (Timeline) Timeline.after('animation', dur('aoe'), function () { ring.remove(); });
